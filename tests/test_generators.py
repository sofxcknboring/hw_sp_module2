...
def test_filter_by_currency_valid(transactions):
    iter_usd_value = filter_by_currency(transactions, 'USD')
    iter_rub_value = filter_by_currency(transactions, 'RUB')
    assert next(iter_usd_value) == {
            "id": 939719570,
            "state": "EXECUTED",
